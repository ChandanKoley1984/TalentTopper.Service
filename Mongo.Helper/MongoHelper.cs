...
namespace MongoHelper
{
    public class MongoHelper : IDisposable
    {
       ...
       // string connectionString = "mongodb://208.78.220.99:27017/";
        ...
        {
            var collection = _database.GetCollection<BsonDocument>(collectionName);
            return collection.Find(Builder.FilterEq(field, value)).CountDocuments();
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            var collection = _database.GetCollection<BsonDocument>(collectionName);
            return collection.Find(Builder.FilterEq(field, id)).CountDocuments();
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            var collection = _database.GetCollection<BsonDocument>(collectionName);
            return collection.Find(Builder.FilterEq<T>(field, value)).CountDocuments();
        }
        #endregion
        /// <summary>
        ...
        public bool InsertMany<T>(string collectionName, IEnumerable<T> documents)
        {
            try
            {
                ...
                {
                    docs.Add(documents.ElementAt(i).ToBsonDocument());
                }
                var collection = _database.GetCollection<BsonDocument>(collectionName);
