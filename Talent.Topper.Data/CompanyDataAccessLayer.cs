...
namespace Talent.Topper.Data
{
    public class CompanyDataAccessLayer
    {
        ...
        {           
            ...
            _contact.Company_ID = _company.ID;
            _contact.Branch_ID = _branch.ID;
            ...
            //_branch.Contact_Id = Convert.ToUInt16(_contact.ID);
            //_dbContext.Entry(_branch).State = EntityState.Modified;


            //_company.Contact_Id = Convert.ToUInt16(_contact.ID);
            //_dbContext.Entry(_company).State = EntityState.Modified;
